...
public class SmartChargingSwitch implements OnPreferenceChangeListener {
    ...
    private static final String FILE = "/sys/devices/virtual/oplus_chg/battery/mmi_charging_enable";
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (enabled) {
            Utils.startService(mContext, com.oneplusparts.SmartChargingService.class);
            ...
            Utils.stopService(mContext, com.oneplusparts.SmartChargingService.class);
